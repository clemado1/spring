...
class SingletonWithPrototypeTest1 {
    ...
    static class ClientBean {
        ...
        @Autowired
//        private ObjectProvider<PrototypeBean> prototypeBeaProvider;
        private Provider<PrototypeBean> prototypeBeaProvider;

        public int login() {
//            PrototypeBean prototypeBean = prototypeBeaProvider.getObject();
            PrototypeBean prototypeBean = prototypeBeaProvider.get();
    ...
    static class PrototypeBean {
        ...
        @PreDestroy
        public void dstroy() {
            System.out.println("PrototypeBean.dstroy");
        }
    }
}
